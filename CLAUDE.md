...
**CRITICAL: 修正・変更の前に仕様を調査すること**

- コード修正・エラー修正・設定変更を行う前に、対象技術の公式仕様をcontext7/WebSearchで調査すること
- 試行錯誤による場当たり的な修正を禁止する。**仕様理解→計画→修正**の順序を徹底すること
- エラー修正時は、エラーメッセージの原因を公式ドキュメントで特定してから修正に着手すること
